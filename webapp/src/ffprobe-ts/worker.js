...
var createFfprobe = (() => {
  ...
  return function(moduleArg = {}) {
    ...
    function findWasmBinary() {
      ...
      return new URL("ffprobe.wasm", import.meta.url).href;
    }
    var wasmBinaryFile;
    ...
    var WORKERFS = { DIR_MODE: 16895, FILE_MODE: 33279, reader: null, mount(mount) {
...
`;
    ...
    var wasmImports = { s: ___cxa_throw, O: ___syscall_faccessat, k: ___syscall_fcntl64, L: ___syscall_fstat64, C: ___syscall_getdents64, Q: ___syscall_ioctl, I: ___syscall_lstat64, J: ___syscall_newfstatat, D: ___syscall_openat, B: ___syscall_renameat, A: ___syscall_rmdir, K: ___syscall_stat64, z: ___syscall_unlinkat, P: __abort_js, x: __embind_register_bigint, T: __embind_register_bool, R: __embind_register_emval, o: __embind_register_float, p: __embind_register_function, f: __embind_register_integer, e: __embind_register_memory_view, S: __embind_register_std_string, l: __embind_register_std_wstring, U: __embind_register_void, N: __emscripten_memcpy_js, W: __emval_call, a: __emval_decref, r: __emval_get_global, q: __emval_get_method_caller, h: __emval_new_array, c: __emval_new_cstring, g: __emval_new_object, V: __emval_run_destructors, b: __emval_set_property, d: __emval_take_value, t: __gmtime_js, u: __localtime_js, E: __tzset_js, w: _clock_time_get, M: _emscripten_date_now, m: _emscripten_get_now, y: _emscripten_resize_heap, G: _environ_get, H: _environ_sizes_get, j: _fd_close, F: _fd_fdstat_get, n: _fd_read, v: _fd_seek, i: _fd_write };
    var wasmExports;
    createWasm();
    ...
    var dynCall_iiiji = Module["dynCall_iiiji"] = (a0, a1, a2, a3, a4, a5) => (dynCall_iiiji = Module["dynCall_iiiji"] = wasmExports["da"])(a0, a1, a2, a3, a4, a5);
    var dynCall_jiiij = Module["dynCall_jiiij"] = (a0, a1, a2, a3, a4, a5) => (dynCall_jiiij = Module["dynCall_jiiij"] = wasmExports["ea"])(a0, a1, a2, a3, a4, a5);
    ...
    var dynCall_jiiji = Module["dynCall_jiiji"] = (a0, a1, a2, a3, a4, a5) => (dynCall_jiiji = Module["dynCall_jiiji"] = wasmExports["ga"])(a0, a1, a2, a3, a4, a5);
    var dynCall_ijii = Module["dynCall_ijii"] = (a0, a1, a2, a3, a4) => (dynCall_ijii = Module["dynCall_ijii"] = wasmExports["ha"])(a0, a1, a2, a3, a4);
    Module["FS"] = FS;
...
var ffprobe_default = createFfprobe;

// src/ffprobe-module.ts
var createFfprobe2 = ffprobe_default;
var ffprobe_module_default = createFfprobe2;

// src/worker.ts
var ctx = self;
var modulePromise = ffprobe_module_default();
var MOUNT = "/work";
function reply(port, msg) {
  port.postMessage(msg);
}
async function handleProbe(file, port) {
...
ctx.onmessage = (event) => {
  ...
  switch (req.type) {
    case "probe":
      handleProbe(req.file, port).catch((err) => {
